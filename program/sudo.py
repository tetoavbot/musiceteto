...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo="https://telegra.ph/file/3470a632a034837abe424.jpg",
        caption=f"""[⌁ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝙼𝚄𝚂𝙸𝙲 LUA 🎸](https://t.me/RDPDDP)\n\n[⌁ 𝙳𝙴𝚅 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝚁𝚁𝙾𝚁 🎸](https://t.me/K_1_1_0)\n\n[⌁ 𝙳𝙴𝚅 𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝙰𝚁𝙻𝙾 🎸](https://t.me/M_A_R_LO_W)""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "𝑆𝑂𝐔𝑅𝐶𝐸 𝐿𝐔𝐴˹ٰٰ˼", url=f"https://t.me/RDPDDP"), 
                ],[
                    InlineKeyboardButton(
                        "･ َِعمقٖ ☕️َِٖ🌿.", url=f"https://t.me/crwvv"),
                ],[
                    InlineKeyboardButton(
                        "أضغط لاضافه ألبوت لمجموعتك 𖣳", url=f"https://t.me/K_1_1_0_bot?startgroup=true"),
                ],
